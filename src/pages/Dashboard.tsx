import { Users, Database, GitBranch, Key, TrendingUp, Activity } from 'lucide-react';
...
const recentActivity = [
  { id: 1, action: 'New customer registered', customer: 'Acme Corp', time: '5 minutes ago', type: 'customer' },
  { id: 2, action: 'Database backup completed', customer: 'TechStart Inc', time: '15 minutes ago', type: 'database' },
  { id: 3, action: 'License renewed', customer: 'DataFlow Ltd', time: '1 hour ago', type: 'license' },
  { id: 4, action: 'Version updated', customer: 'CloudSync Inc', time: '2 hours ago', type: 'version' },
  { id: 5, action: 'New user added', customer: 'Innovate Co', time: '3 hours ago', type: 'customer' },
];
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {kpiData.map((kpi) => {
          const Icon = kpi.icon;
          return (
            <Card key={kpi.title} className="border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-2">
                      ...
                      <span className={`text-sm ${kpi.trend === 'up' ? 'text-green-600' : 'text-gray-500'}`}>
                        {kpi.change}
                      </span>
                    </div>
                  </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border-gray-200 shadow-sm">
          <CardHeader>
            <CardTitle>Customer & Database Growth</CardTitle>
        ...
        <Card className="border-gray-200 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Active licenses by plan type</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between">
                ...
                {licenseDistributionData.map((item) => (
                  <div key={item.name} className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">{item.value} licenses</p>
                    </div>
                  </div>
                ))}
              </div>
